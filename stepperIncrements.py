...
# data taken from tables on camera lens datasheet. Zoom should only change to one of these set focal lengths. Focus motor should move to corresponding position in the array. 
focal_lengths = [4.15, 4.96, 5.77, 6,58, 7.39, 8.19, 9.0, 9.7, 9.9]
z_steps_at_lengths = [0, 2288, 4576, 6868, 9156, 11444, 13732, 15736, 16292]
infinite_focus_positions = [36264, 24820, 17848, 12916, 6668, 3020, 1576, 1692, 1932]
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if axis == "f":
            ...
            move_Z_motor(z_steps_at_lengths[target_position])
            move_F_motor(infinite_focus_positions[target_position])
            print("Now at focal length:", focal_lengths[target_position])
